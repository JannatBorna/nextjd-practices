# The project must be done with Page Router so say No to App Router. And you must add Ant Design as a CSS component library and use it. Now let's see what to do
